...
#### 2\. `r emo::ji("page_facing_up")` New R Quarto Document
  ...
  <img src="imagenes/quarto_new_file.png" width="75%"/>
]

.pull-right[
<br>

  <img src="imagenes/quarto_new_file2.png" width="75%"/>
...
```{r, echo=FALSE}
xaringanExtra::embed_xaringan("https://haydeeperuyero.github.io/Xaringan_RLadies/Quarto_ejemplos/crear_diapositivas.html", ratio="16:7")
```
...
```{r, echo=FALSE}
xaringanExtra::embed_xaringan("https://haydeeperuyero.github.io/Xaringan_RLadies/Quarto_ejemplos/chunks.html", ratio="16:7")
```
...
```{r, echo=FALSE}
xaringanExtra::embed_xaringan("https://haydeeperuyero.github.io/Xaringan_RLadies/Quarto_ejemplos/sintaxis.html", ratio="16:7")
```
