...
```{r, echo=FALSE}
xaringanExtra::embed_xaringan("Quarto_ejemplos/crear_diapositivas.html", ratio="16:7")
```
...
```{r, echo=FALSE}
xaringanExtra::embed_xaringan("Quarto_ejemplos/chunks.html", ratio="16:7")
```
...
```{r, echo=FALSE}
xaringanExtra::embed_xaringan("Quarto_ejemplos/sintaxis.html", ratio="16:7")
```
...
```{r, echo=FALSE}
xaringanExtra::embed_xaringan("Quarto_ejemplos/alineacion.html", ratio="16:7")
```
