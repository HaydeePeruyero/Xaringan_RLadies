...
```{r, echo=FALSE}
xaringanExtra::embed_xaringan("https://haydeeperuyero.github.io/Xaringan_RLadies/Quarto_ejemplos/crear_diapositivas.html")
```
...
.left[Abarcamos toda la diapositiva, poniendo una parte del texto en la izquierda]

--

.right[Y posteriormente complementamos con texto a la derecha]

--

----

.center[También podemos agregar texto en el centro, aunque para esta opción podemos usar solo una de las alineaciones]
...
* `.pull-left[]` _jalar-izquierda_  

* Puede incluir imagenes
...
* `.pull-right[]` _jalar-derecha_ 

* Abarca el otro 47%
]
--
----
.center[.morado-claro[Y puede incluir otras alineaciones `r emo::ji("smile")`]]
...
.left-column[
* **`.left-column[]` _columna-izquierda_ coloca  una columna a la izquierda**
...
---
background-image: url(rladies_logo.jpeg)

class: middle, center, inverse

# **background-image**
***Sin indicar tamaño del fondo***
---
class: middle, center
